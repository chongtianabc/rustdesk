...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("doc_mac_permission", "https://clouddesktop.com/docs/en/client/mac/#enable-permissions"),
        ...
        ("doc_fix_wayland", "https://clouddesktop.com/docs/en/client/linux/#x11-required"),
        ...
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, RustDesk will not use UDP 31116 any more, TCP 31116 will be used instead."),
